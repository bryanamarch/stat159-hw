...
#Conclusion
Using the statistics on the estimates $\hat{\beta_0}$ and $\hat{\beta_1}$, the model analysis, and the visual representation of the least sqaures fitted line, we can see that the model $Sales \approx \beta_0 + \beta_1*TV$ was a reasonable assumption. 